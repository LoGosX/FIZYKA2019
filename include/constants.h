...
namespace constants
{
	...
	const float INITIAL_VELOCITY_MODIFIER = 1000.0f;
	...
	const int OK_VERTICES_COUNT = 150000; //how much vertices should we draw (number of particles on screen * number of vertices in particle sprite <= OK_VERTICES_COUNT)
